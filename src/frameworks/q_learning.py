...
# TODO: design for distributional learning
# Needs to work for discrete and continuous cases
# > How do they differ?
#       action selection
#           discrete ~ greedy selection
#           continuous ~ generated by actor network
#               ... still maximizes Q = expectation over Z
#       actor error ~ continuous case, can still use calc_q_error_actor
# > How are they the same?
#       Q calculation ~ expectation calculation
#       weight redistribution (_redistribute_weights)
#       X-entropy loss
#           targets = weights from weight redistribution
#           Q from discrete = critic from continuous
#
# Design?
# > critic_distro function:
#       takes in selected action a* (as well as action_t)
